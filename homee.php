...
<html lang="en">
    ...
    <body>
        ...
        <h1 class="title">Cek Tipe Kulit Mu</h1>
            <div class="info">
                <div class="normal"><img src="images/normal.jpg" width="200px" height="270px" ></div>   
                <div class="kering"><img src="images/kering.jpg"  width="200x" height="270px" ></div>   
                <div class="kombi"><img src="images/kombi.jpg"  width="200x" height="270px" ></div>   
                <div class="minyak"><img src="images/minyak.jpg"  width="210px" height="278px" ></div> 
        ...
        <h4 class="title">New Products</h4>
            <div class="info">
                <a href="product.php" class="box">
                    <img src="images/gambar1.jpeg"  height="270px" width="280px" alt="">
                    <h5>Somethinc</h5>
                </a>
                <a href="product.php" class="box">
                    <img src="images/gambar2.jpeg"  height="270px" width="210px" alt="">
                    <h5>Avoskin</h5>
                </a>
                <a href="product.php" class="box">
